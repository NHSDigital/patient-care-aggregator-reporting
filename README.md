# patient-care-aggregator-reporting

![Build](https://github.com/NHSDigital/patient-care-aggregator-reporting/workflows/Build/badge.svg?branch=master)

This is a specification for the *patient-care-aggregator-reporting* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/patient-care-aggregator-reporting/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/patient-care-aggregator-reporting/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `patient-care-aggregator-reporting-target`.
